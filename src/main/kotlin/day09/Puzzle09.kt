...
private fun runMoves(ropeLength: Int, input: String): MutableSet<Pair<Int, Int>> {
    ...
    input.lines().forEach {
        ...
        when (parts[0]) {
            ...
            "L" -> direction = Direction.W
            "U" -> direction = Direction.N
            "D" -> direction = Direction.S
        }
...
fun nextPoint(current: Pair<Int, Int>, direction: Direction): Pair<Int, Int> {
    return Pair(current.first + direction.dX, current.second + direction.dY)
}
